...
export default function Footer() {
    ...
    const SERVICE_ITEMS = [
        ...
        t('services.businessWebsite'),
        t('services.ecommerce'),
        t('services.customApp'),
    ];
            ...
            <footer className="ft-root">
                ...
                <div className="ft-cta">
                    ...
                    <motion.h2 className="ft-cta-heading" {...fadeUp(0.08)}>
                        {t('footer.cta.title.before')}<span>{t('footer.cta.title.highlight')}</span>{t('footer.cta.title.after')}
                    </motion.h2>
                ...
                <div className="ft-body">
                    <div className="ft-grid">
                        ...
                        {/* Brand */}
                        <motion.div {...fadeUp(0)}>
                            <a href="/" aria-label="Zocktech home">
                                <img
                        ...
                        <motion.div {...fadeUp(0.08)}>
                            <p className="ft-col-title">{t('footer.col.navigation')}</p>
                        ...
                        <motion.div {...fadeUp(0.14)}>
                            <p className="ft-col-title">{t('footer.col.services')}</p>
                        ...
                        <motion.div {...fadeUp(0.2)}>
                            <p className="ft-col-title">{t('footer.col.contact')}</p>
                ...
                <div className="ft-bottom-outer" style={{ marginTop: '48px' }}>
                    <div className="ft-bottom">
                        <span className="ft-bottom-text">{t('footer.copyright')}</span>
                        <span className="ft-bottom-badge">{t('footer.badge')}</span>
                    </div>
                </div>
