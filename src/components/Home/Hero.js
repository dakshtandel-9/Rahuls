    ...
    return (
        <section className="relative overflow-hidden min-h-[90vh] flex items-center">
            ...
            <div className="relative z-10 mx-auto max-w-7xl px-4 pt-24 pb-20 text-center w-full">
                ...
                {ready && (
                    <div key={`${animationKey}-${language}`} className="mt-6">
                        <TextAnimate
                            animation="blurIn"
                            by="word"
                            as="h1"
                ...
                >
                    {t('hero.subhead.before')}
                    <span className="text-gray-900 dark:text-white font-semibold">{t('hero.subhead.duration')}</span>
                    {t('hero.subhead.after')}
                </motion.p>
