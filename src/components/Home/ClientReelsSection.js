...
// ─── Reel card ────────────────────────────────────────────────────────────────
function ReelCard({ reel, onOpen, index, tagLabel }) {
    return (
        <motion.div
            className="cr-card"
            onClick={() => onOpen(reel)}
        ...
        >
            ...
            <div className="cr-card-footer">
                <div className="cr-client-info">
                    <span className="cr-client-tag">{tagLabel}</span>
            ...
            <section id="client-reels" className="cr-section">
                <div className="cr-inner">
                    ...
                    <div className={`cr-grid${isFew ? ' cr-grid--few' : ''}`}>
                        {reels.map((reel, i) => (
                            <ReelCard key={reel.id} reel={reel} onOpen={setActive} index={i} tagLabel={t('reels.tag')} />
                        ))}
                    </div>
